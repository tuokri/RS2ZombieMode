...
/** Physics Wheels */
    ...
    ArmorHitZones(18)=(ZoneName=FLOORPLATE,PhysBodyBoneName=Chassis,ArmorPlateName=FLOORUNDER)
    ArmorHitZones(19)=(ZoneName=ENGINEWALLONE,PhysBodyBoneName=Chassis,ArmorPlateName=ENGINECOMPARTMENT)
    ArmorHitZones(20)=(ZoneName=ENGINEWALLTWO,PhysBodyBoneName=Chassis,ArmorPlateName=ENGINECOMPARTMENT)
    ArmorHitZones(21)=(ZoneName=HATCHRIMONE,PhysBodyBoneName=Chassis,ArmorPlateName=HATCHRIM)
    ArmorHitZones(22)=(ZoneName=HATCHRIMTWO,PhysBodyBoneName=Chassis,ArmorPlateName=HATCHRIM)
    ArmorHitZones(23)=(ZoneName=HATCHRIMTHREE,PhysBodyBoneName=Chassis,ArmorPlateName=HATCHRIM)
    ArmorHitZones(24)=(ZoneName=HATCHRIMFOUR,PhysBodyBoneName=Chassis,ArmorPlateName=HATCHRIM)
    ArmorHitZones(25)=(ZoneName=HATCHRIMEFIVE,PhysBodyBoneName=Chassis,ArmorPlateName=HATCHRIM)
    

    ArmorPlates(0)=(PlateName=REARCABIN,ArmorZoneType=AZT_Back,PlateThickness=38,OverallHardness=85,bHighHardness=false)
    ArmorPlates(1)=(PlateName=UNDERSIDELEFT,ArmorZoneType=AZT_Floor,PlateThickness=28,OverallHardness=85,bHighHardness=false)
    ArmorPlates(2)=(PlateName=UNDERSIDERIGHT,ArmorZoneType=AZT_Floor,PlateThickness=28,OverallHardness=85,bHighHardness=false)
    ArmorPlates(3)=(PlateName=UNDERSIDEFRONT,ArmorZoneType=AZT_Floor,PlateThickness=38,OverallHardness=85,bHighHardness=false)
    ArmorPlates(4)=(PlateName=FRONTUPPER,ArmorZoneType=AZT_Front,PlateThickness=38,OverallHardness=85,bHighHardness=false)
    ArmorPlates(5)=(PlateName=RIGHTSIDEUPPER,ArmorZoneType=AZT_Right,PlateThickness=44,OverallHardness=85,bHighHardness=false)
    ArmorPlates(6)=(PlateName=LEFTSIDEUPPER,ArmorZoneType=AZT_Left,PlateThickness=44,OverallHardness=85,bHighHardness=false)
    ArmorPlates(7)=(PlateName=LEFTSIDELOWER,ArmorZoneType=AZT_Left,PlateThickness=38,OverallHardness=85,bHighHardness=false)
    ArmorPlates(8)=(PlateName=RIGHTSIDELOWER,ArmorZoneType=AZT_Right,PlateThickness=38,OverallHardness=85,bHighHardness=false)
    ArmorPlates(9)=(PlateName=ROOFARMOR,ArmorZoneType=AZT_Roof,PlateThickness=38,OverallHardness=85,bHighHardness=false)
    ArmorPlates(10)=(PlateName=MGHATCH,ArmorZoneType=AZT_Roof,PlateThickness=38,OverallHardness=85,bHighHardness=false)
    ArmorPlates(11)=(PlateName=MGSHEILD,ArmorZoneType=AZT_Roof,PlateThickness=10,OverallHardness=400,bHighHardness=true)
    ArmorPlates(12)=(PlateName=FLOORUNDER,ArmorZoneType=AZT_Floor,PlateThickness=28,OverallHardness=85,bHighHardness=false)
    ArmorPlates(13)=(PlateName=ENGINECOMPARTMENT,ArmorZoneType=AZT_Front,PlateThickness=15,OverallHardness=85,bHighHardness=false)
    ArmorPlates(14)=(PlateName=HATCHRIM,ArmorZoneType=AZT_Front,PlateThickness=38,OverallHardness=85,bHighHardness=false)
    ...
    VehHitZones(2)=(ZoneName=FUELTANKLEFT,DamageMultiplier=5.0,VehicleHitZoneType=VHT_Fuel,ZoneHealth=100,KillPercentage=0.2)
    VehHitZones(3)=(ZoneName=FUELTANKRIGHT,DamageMultiplier=5.0,VehicleHitZoneType=VHT_Fuel,ZoneHealth=100,KillPercentage=0.2)
    ...
    VehHitZones(10)=(ZoneName=LEFTBRAKES,DamageMultiplier=1.0,VehicleHitZoneType=VHT_Mechanicals,ZoneHealth=100,VisibleFrom=7)
    VehHitZones(11)=(ZoneName=RIGHTBRAKES,DamageMultiplier=1.0,VehicleHitZoneType=VHT_Mechanicals,ZoneHealth=100,VisibleFrom=11)
    VehHitZones(12)=(ZoneName=RIGHTTRACKONE,DamageMultiplier=1.0,VehicleHitZoneType=VHT_Track,ZoneHealth=200)
    VehHitZones(13)=(ZoneName=RIGHTTRACKTWO,DamageMultiplier=1.0,VehicleHitZoneType=VHT_Track,ZoneHealth=200)
    VehHitZones(14)=(ZoneName=MGGUNNERBODY,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewBody,CrewSeatIndex=1,SeatProxyIndex=1,CrewBoneName=Root_MG_HITBOX)
    VehHitZones(15)=(ZoneName=MGGUNNERHEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=1,SeatProxyIndex=1,CrewBoneName=Root_MG_head_HITBOX)
    VehHitZones(16)=(ZoneName=DRIVERBODY,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewBody,CrewSeatIndex=0,SeatProxyIndex=0,CrewBoneName=Root_Driver_HITBOX)
    VehHitZones(17)=(ZoneName=DRIVERHEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=0,SeatProxyIndex=0,CrewBoneName=Root_Driver_head_HITBOX)
    VehHitZones(18)=(ZoneName=PASS1BODY,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewBody,CrewSeatIndex=2,SeatProxyIndex=2)
    VehHitZones(19)=(ZoneName=PASS1HEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=2,SeatProxyIndex=2)
    VehHitZones(20)=(ZoneName=PASS2BODY,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewBody,CrewSeatIndex=3,SeatProxyIndex=3)
    VehHitZones(21)=(ZoneName=PASS2HEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=3,SeatProxyIndex=3)
    VehHitZones(22)=(ZoneName=PASS3BODY,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewBody,CrewSeatIndex=4,SeatProxyIndex=4)
    VehHitZones(23)=(ZoneName=PASS3HEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=4,SeatProxyIndex=4)
    VehHitZones(24)=(ZoneName=PASS4BODY,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewBody,CrewSeatIndex=5,SeatProxyIndex=5)
    VehHitZones(25)=(ZoneName=PASS4HEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=5,SeatProxyIndex=5)
    VehHitZones(26)=(ZoneName=PASS5BODY,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewBody,CrewSeatIndex=6,SeatProxyIndex=6)
    VehHitZones(27)=(ZoneName=PASS5HEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=6,SeatProxyIndex=6)
    VehHitZones(28)=(ZoneName=PASS6BODY,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewBody,CrewSeatIndex=7,SeatProxyIndex=7)
    VehHitZones(29)=(ZoneName=PASS6HEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=7,SeatProxyIndex=7)
    VehHitZones(30)=(ZoneName=PASS7BODY,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewBody,CrewSeatIndex=8,SeatProxyIndex=8)
    VehHitZones(31)=(ZoneName=PASS7HEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=8,SeatProxyIndex=8)
    VehHitZones(32)=(ZoneName=PASS8BODY,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewBody,CrewSeatIndex=9,SeatProxyIndex=9)
    VehHitZones(33)=(ZoneName=PASS8HEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=9,SeatProxyIndex=9)
    VehHitZones(34)=(ZoneName=PASS9BODY,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewBody,CrewSeatIndex=10,SeatProxyIndex=10)
    VehHitZones(35)=(ZoneName=PASS9HEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=10,SeatProxyIndex=10)
    VehHitZones(36)=(ZoneName=PASS10BODY,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewBody,CrewSeatIndex=11,SeatProxyIndex=11)
    VehHitZones(37)=(ZoneName=PASS10HEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=11,SeatProxyIndex=11)
    VehHitZones(38)=(ZoneName=PASS11BODY,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewBody,CrewSeatIndex=12,SeatProxyIndex=12)
    VehHitZones(39)=(ZoneName=PASS11HEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=12,SeatProxyIndex=13)
