class PAPWeap_Katana extends ROMeleeWeapon;
...
defaultproperties
{
	WeaponContentClass(0)="PicksAndPistols.PAPWeap_Katana_Content"
	WeaponContentClass(1)="PicksAndPistols.PAPWeap_Katana_Level2"
	WeaponContentClass(2)="PicksAndPistols.PAPWeap_Katana_Level3"
	...
	// ClassicWeaponContentClass="PicksAndPistols.PAPWeap_Katana_Level2"
	...
	// MAIN FIREMODE
	InstantHitDamageTypes(0)=class'PAPDmgType_Katana'

	// MELEE FIREMODE
	InstantHitDamageTypes(MELEE_ATTACK_FIREMODE)=class'PAPDmgType_KatanaStab'

	// DISMEMBERMENT DAMAGE
	DismemberDamageType=class'PAPDmgType_KatanaChop'
